...
public:
    ...
    Track() {
        P4_L.SetPxPyPzM(0, 0, 0, lambdamass);
        P4_p.SetPxPyPzM(0, 0, 0, protonmass);
        P4_pi.SetPxPyPzM(0, 0, 0, pionmass);
    ...
    double gettheta_pi() const { return theta_p; }
	...
	cout << "Lambda phi: " << phi_L << "\n";
        ...
        cout << "Proton/pion theta: " << theta_pi << "\n";
    }
};
